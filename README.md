...
[![Java CI](https://github.com/Sangameshwarmelkunde/Java-Maven-library-template/actions/workflows/1.pipeline.yml/badge.svg)](https://github.com/Sangameshwarmelkunde/Java-Maven-library-template/actions/workflows/1.pipeline.yml)
[![Maven Central](https://img.shields.io/maven-central/v/io.github.sangameshwarmelkunde/fancy-library-name.svg)](https://central.sonatype.com/artifact/io.github.sangameshwarmelkunde/fancy-library-name)
[![Contributor Covenant](https://img.shields.io/badge/Contributor%20Covenant-2.1-4baaaa.svg)](CODE_OF_CONDUCT.md)
[![Javadoc](https://img.shields.io/badge/JavaDoc-Online-green)](https://Sangameshwarmelkunde.github.io/Java-Maven-library-template/javadoc/)
...
## CI/CD Pipeline
The heart of this template is the ['Main GitHub Actions CI/CD Pipeline'](https://github.com/Sangameshwarmelkunde/Java-Maven-library-template/actions/workflows/1.pipeline.yml).
...
Please define the secrets via your repository settings. ([Settings > Security > Secrets and variables > Actions](https://github.com/Sangameshwarmelkunde/Java-Maven-library-template/settings/secrets/actions))
...
To host the generated Javadoc, configure GitHub Pages for your repository to deploy from branch `gh-pages`. You can also find all deployments under ['pages-build-deployment'](https://github.com/Sangameshwarmelkunde/Java-Maven-library-template/actions/workflows/pages/pages-build-deployment).
